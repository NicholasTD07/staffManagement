...
#
# Created: Sun Apr 29 16:39:23 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.shiftGroupAction = QtGui.QAction(MainWindow)
        self.shiftGroupAction.setObjectName(_fromUtf8("shiftGroupAction"))
        ...
        self.staffMenu.addAction(self.shiftGroupAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupStaffAction.setText(QtGui.QApplication.translate("MainWindow", "员工分组(&G)", None, QtGui.QApplication.UnicodeUTF8))
        self.groupStaffAction.setShortcut(QtGui.QApplication.translate("MainWindow", "Ctrl+G", None, QtGui.QApplication.UnicodeUTF8))
        self.shiftGroupAction.setText(QtGui.QApplication.translate("MainWindow", "员工换班(&C)", None, QtGui.QApplication.UnicodeUTF8))
        self.shiftGroupAction.setToolTip(QtGui.QApplication.translate("MainWindow", "员工换班(C)", None, QtGui.QApplication.UnicodeUTF8))
        self.shiftGroupAction.setShortcut(QtGui.QApplication.translate("MainWindow", "Ctrl+C", None, QtGui.QApplication.UnicodeUTF8))
